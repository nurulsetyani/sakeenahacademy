...
export default async function AdminTahsinPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-parchment-500">Jadwalkan sesi Tahsin dan kelola presensi murid.</p>
      ...
      {courses && courses.length > 0 ? (
        ...
        <div className="card-surface mt-6 p-14 text-center">
          <p className="text-sm text-parchment-600">Belum ada kelas Tahsin.</p>
        </div>
      )}
